...
SELECT DEPARTURE_DELAY, COUNT(*) AS NUM_DELAYS, ROUND(AVG(ELAPSED_TIME), 2) AS AVG_ELAPSED_TIME,
ROUND(AVG(DISTANCE), 2) AS AVG_DISTANCE, sum(DIVERTED) as diverted_flights, avg(TAXI_IN+TAXI_OUT) as time_in_taxi
